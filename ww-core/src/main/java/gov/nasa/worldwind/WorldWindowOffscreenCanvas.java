...
/**
 * <code>WorldWindowOffscreenCanvas</code> provides an offscreen, platform-independent canvas for displaying World Wind
 ...
 * rendering is performed to an offscreen frame-buffer by making use of a {@link javax.media.opengl.GLOffscreenAutoDrawable}.
 * To retrieve an image of the offscreen WorldWindow, a call must to be made to {@link #redrawNow()} followed by
 * {@link com.jogamp.opengl.util.awt.AWTGLReadBufferUtil#readPixelsToBufferedImage(javax.media.opengl.GL, boolean)}.
 * The size of the offscreen WorldWindow can be set via the {@link #setPreferredSize(java.awt.Dimension)} method.
 * <p/>
...
public class WorldWindowOffscreenCanvas implements WorldWindow, PropertyChangeListener
{
    ...
    public WorldWindowOffscreenCanvas(Dimension dimension)
    {
        try
        {
            ...
            this.canvas = factory.createOffscreenAutoDrawable(null, caps, chooser, dimension.width, dimension.height, null);
