...
public class AirspaceAttributesTest
{
    ...
    public void testPropertyAccessors()
    {
        ...
        assertEquals(attrs.getInteriorOpacity(), 0.5, 0.0001);
        assertEquals(attrs.getOutlineOpacity(), 0.75, 0.0001);
        assertEquals(attrs.getOutlineWidth(), 10.0, 0.0001);
    }
    ...
    public void testDeprecatedPropertyAccessors()
    {
        ...
        assertEquals(attrs.getOutlineMaterial(), Material.GREEN);
        assertEquals(attrs.getOpacity(), 0.5, 0.0001);
        assertEquals(attrs.getOutlineOpacity(), 0.75, 0.0001);
        assertEquals(attrs.getOutlineWidth(), 10.0, 0.0001);
