...
public class TrackAirspaceTest
{
    ...
    public static void assertTrackAirspaceEquals(TrackAirspace expected, TrackAirspace actual)
    {
        ...
        List<gov.nasa.worldwind.render.airspaces.Box> expectedLegs = expected.getLegs();
        List<gov.nasa.worldwind.render.airspaces.Box> actualLegs = actual.getLegs();
    ...
    public static void assertLegEquals(gov.nasa.worldwind.render.airspaces.Box expected, gov.nasa.worldwind.render.airspaces.Box actual)
    {
